...
public class HelpRenderer implements Disposable {

	private static final String TAG = HelpRenderer.class.getName();

	private OrthographicCamera camera;
	private OrthographicCamera helpCamera;
	private SpriteBatch upBatch;
	private SpriteBatch downBatch;
	private ShapeRenderer shadow;
	...
	private void init () {
		...
		downBatch = new SpriteBatch();
		shadow = new ShapeRenderer();
		shape = new ShapeRenderer();
		camera = new OrthographicCamera(Constants.VIEWPORT_WIDTH, Constants.VIEWPORT_HEIGHT);
		helpCamera = new OrthographicCamera(Constants.VIEWPORT_WIDTH, Constants.VIEWPORT_HEIGHT); 
		helpCamera.setToOrtho(true);
...
//	}
    ...
    private void renderDown(SpriteBatch batch,int level) {}
    
    private void renderUp(SpriteBatch batch) {}
	...
	private void renderPowerUnit(SpriteBatch batch) {
		...
		reg = gameController.resources.started ? gameController.resources.powerButton.on :  gameController.resources.powerButton.off;
	...
	private void renderButton(SpriteBatch batch) {
		TextureRegion  reg = null;
		reg = gameController.resources.button.up;
