...
public class HelpNavigation extends AbstractGameObject{
	
	public TextureRegion play;
	public TextureRegion next;
	public TextureRegion prev;
...
//	}
	...
	public HelpNavigation(float x, float y, float width, float height) {
		super( x,  y,  width,  height);
		init();
	}
	
	public void init () {
		next = Assets.instance.assetUi.next;
		prev = Assets.instance.assetUi.prev;
		play = Assets.instance.assetUi.play;
	}
